  ...
  return (
    <div>
      <div className="text-sm p-2 px-5 border-b bg-[#F8F8F8] text-[#43403B] space-y-2">
        <p>
          Welcome to DegreeGuru, your ultimate companion in navigating the
          academic landscape of Stanford.
        </p>
        <h2>Here&apos;s how it works:</h2>
        <ol>
          <li>
            <strong>1. Ask Your Question:</strong> Simply type your question
            into the text field at the bottom of the page.
          </li>
          <li>
            <strong>2. Get Informed:</strong> Hit enter or click the Send
            button, and watch as DegreeGuru works its magic.
          </li>
        </ol>
        <p>
          Ready to dive in? See an example question and answer below to get a
          taste of what DegreeGuru can offer.
        </p>
      </div>
      <Message
        message={{
